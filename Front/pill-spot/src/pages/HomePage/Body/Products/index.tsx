...
const Products = () => {
  ...
  return (
    <div>
      ...
      <Marquee speed={100} direction="right" pauseOnClick gradient gradientColor="#334c8380" gradientWidth={100} className="rounded-2xl"  >
          ...
          <div className="mt-6">
            ...
            <ul className="space-y-2">
              {categories.map((category, index) => (
                <div className="flex items-center justify-start gap-5 bg-blue-50 p-1 rounded-2xl">
                  <img src={img} className="w-20 rounded-xl" />
                <li
                  key={index}
                  className="relative text-lg font-medium cursor-pointer group text-[#334c83]"
                >
                  {category}
