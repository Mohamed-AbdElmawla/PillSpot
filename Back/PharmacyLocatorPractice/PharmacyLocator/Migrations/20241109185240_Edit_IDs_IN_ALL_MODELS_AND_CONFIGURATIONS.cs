...
{
    /// <inheritdoc />
    public partial class Edit_IDs_IN_ALL_MODELS_AND_CONFIGURATIONS : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SearchId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_PharmacyMedicines_PharmacyId_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_PharmacyMedicines_pharmacyId_MedicineId",
                        columns: x => new { x.pharmacyId, x.MedicineId },
                        principalTable: "PharmacyMedicines",
                        principalColumns: new[] { "PharmacyId", "MedicineId" });
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1feb0fcc-c08b-4207-b33e-007073ac392b", null, "User", "USER" },
                    { "48ed2c18-dfbe-402c-a3c6-0f17959ba368", null, "Admin", "ADMIN" },
                    { "7f3d3928-584f-4a52-8a55-4ddbae081136", null, "SuperAdmin", "SUPERADMIN" },
                    { "efcaa5a8-1188-4bc2-8a19-97a3a02744eb", null, "Pharmacy", "PHARMACY" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_PharmacyId_MedicineId",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_pharmacyId_MedicineId",
                table: "OrderItems",
                columns: new[] { "pharmacyId", "MedicineId" });
