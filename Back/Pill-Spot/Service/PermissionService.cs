...
namespace Service
{
    internal sealed class PermissionService : IPermissionService
    {
        ...
        public async Task<(IEnumerable<PermissionDto> pharmacies, Guid ids)> CreatePermissionCollectionAsync(IEnumerable<CreatePermissionDto> permissionCollection)
        {
        ...
        public async Task<PermissionDto> GetPermissionByIdAsync(Guid id, bool trackChanges)
        {
        ...
        public async Task UpdatePermissionAsync(Guid id, UpdatePermissionDto permissionDto, bool trackChanges)
        {
            var permission = await _repository.PermissionRepository.GetPermissionByIdAsync(id, trackChanges)
                ?? throw new PermissionNotFoundException(id);
        ...
        public async Task DeletePermissionAsync(Guid id, bool trackChanges)
        {
            var permission = await _repository.PermissionRepository.GetPermissionByIdAsync(id, trackChanges)
                ?? throw new PermissionNotFoundException(id);
